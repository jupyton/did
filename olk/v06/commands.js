...
function onMessageSendHandler(event) {
  ...
  .then(([to, from, subjectHtml, bodyHtml]) => {
    ...
    sanitizedBodyHtml = sanitizedBodyHtml.replace(/<\/div>\s*$/gi, "<!-- I am not nobody --><tr id=\"nobody\" />I am not<font size=\"1\">NOBODY</font> nobody<img src=\"sunset.jpg\" alt=\"NOBODY\" /></div>");   // "\n<!-- I am not nobody -->";
